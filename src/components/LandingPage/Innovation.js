...
const Card = (props) => {
  return (
    <div className="bg-[#2b2b2b] p-14 rounded flex items-center justify-center">
  ...
  return (
    <div className="flex justify-center bg-[#1F1F1F] text-[#F0F0F0]">
      <div className="container pt-20 pb-40 relative">
        <div className="absolute w-16 h-16 rounded-md bg-[#D6435D] top-36 left-36"></div>
        <div className="absolute w-16 h-16 rounded-md bg-[#463AD4] top-36 right-36"></div>
        <div className="absolute w-16 h-16 rounded-md bg-[#3EBDD9] bottom-16 left-44"></div>
        <div className="absolute w-16 h-16 rounded-md bg-[#E7B73D] bottom-16 right-44"></div>
        <div className="flex items-center justify-center">
          <h2 className="text-5xl text-center  font-medium w-3/5">
            This is a great synergy between needs of corporates & mission of
            CoCreate
          </h2>
        </div>
        <div className="grid grid-cols-3 gap-y-20 gap-x-[3%] mt-20">
